...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        pstart = self.start.plus(other_line)
        pend = self.end.plus(other_line)

        new = Line(pstart, pend)
    ...
    def line_minus(self, other_line):
        ...
        mstart = self.start.minus(other_line)
        mend = self.end.minus(other_line)

        new = Line(mstart, mend)
